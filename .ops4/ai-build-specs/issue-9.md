...
## Objective
Update the application's UI to use the client's updated design system by applying new design tokens, colors, spacing, and component variants. Do not change any layouts, navigation, page content, or business logic. All updates must use existing component patterns and maintain design continuity across all screens.
...
## Requirements
- Replace current design tokens (colors, spacing, typography, radii, shadows) with those from the updated design system throughout the codebase.
- Update all shadcn/ui and custom components to use the new color palette, spacing scale, and component variants as defined in the updated design system.
- Do not alter any layouts, navigation structure, page content, or business logic.
- Do not add, remove, or restructure any screens, navigation items, or workflows.
- Maintain all existing component usage and patterns; only update the underlying design tokens and variants.
- Ensure all 64 pages and their fields/filters continue to render as before, but with the new visual style.
- Retain accessibility (WCAG 2.1 AA), keyboard navigation, and visible focus states as per design guidelines.
...
## Acceptance Criteria
- All screens and components reflect the updated design system tokens and variants, with no layout or navigation changes.
- No screens, fields, or workflows are missing or altered beyond visual updates.
- All 64 pages and their fields/filters render correctly with the new design system.
- Accessibility, keyboard navigation, and focus-visible states are preserved.
- Lint passes
- Build passes
...
`ai-build/issue-9-update-ui-to-use-latest-design-system-tokens-and`
...
PR title should be:
AI Build: Update UI to Use Latest Design System Tokens and Component Variants
